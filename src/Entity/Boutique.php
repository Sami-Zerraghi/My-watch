...

{
    ...
    #[ORM\OneToMany(mappedBy: 'boutique', targetEntity: Montre::class, orphanRemoval: true)]
    ...
    #[Vich\UploadableField(mapping: 'boutique', fileNameProperty: 'imageName',)]
    ...
    public function removeMontre(Montre $montre): static
    {
        if ($this->montres->removeElement($montre)) {
            ...
            if ($montre->getBoutique() === $this) {
                $montre->setBoutique(null);
            }
        }
